...
,p_group_id=>wwv_flow_imp.id(6195961184676583)
,p_javascript_code_onload=>'apex.pwa.initPushSubscriptionPage();'
,p_step_template=>wwv_flow_imp.id(5701887753676190)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6197575670676584)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6197883735676584)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6197188571676584)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6198345654676585)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(6197883735676584)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(6198639312676585)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6199183823676585)
,p_event_id=>wwv_flow_imp.id(6198639312676585)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6199607721676585)
,p_event_id=>wwv_flow_imp.id(6198639312676585)
