...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(5879598333676245)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5879862458676258)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5880137671676259)
,p_plugin_attribute_id=>wwv_flow_imp.id(5879862458676258)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5880573621676260)
,p_plugin_attribute_id=>wwv_flow_imp.id(5879862458676258)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5880911706676260)
,p_plugin_attribute_id=>wwv_flow_imp.id(5879862458676258)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5881395719676261)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(5879862458676258)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5881675611676261)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5881951117676261)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5882260541676261)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5882545497676262)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5882896319676262)
,p_plugin_attribute_id=>wwv_flow_imp.id(5882545497676262)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5883283746676262)
,p_plugin_attribute_id=>wwv_flow_imp.id(5882545497676262)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5883630142676262)
,p_plugin_attribute_id=>wwv_flow_imp.id(5882545497676262)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5884050750676263)
,p_plugin_attribute_id=>wwv_flow_imp.id(5882545497676262)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5884454453676263)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5884784921676263)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885199263676263)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885542893676264)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5885956700676264)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5886318858676264)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5886758552676264)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5887116441676265)
,p_plugin_attribute_id=>wwv_flow_imp.id(5884454453676263)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5887549745676265)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1805930370417790004)
,p_plugin_id=>wwv_flow_imp.id(5879598333676245)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
