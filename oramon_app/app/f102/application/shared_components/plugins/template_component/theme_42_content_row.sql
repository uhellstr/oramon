...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(5907717028676296)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1933145561069747998)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1933145006057747997)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1676252942327474484)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5908683441676304)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5908961800676304)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5909261951676305)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5909549611676305)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5909833257676305)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5910128867676305)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5910484108676306)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(5909833257676305)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1933145561069747998)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5910753793676306)
,p_plugin_attribute_id=>wwv_flow_imp.id(5910484108676306)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5911118533676306)
,p_plugin_attribute_id=>wwv_flow_imp.id(5910484108676306)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5911503368676306)
,p_plugin_attribute_id=>wwv_flow_imp.id(5910484108676306)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5911911347676307)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(5910484108676306)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5912206122676307)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5912599915676307)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5912851070676307)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5913195041676308)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5913408056676308)
,p_plugin_attribute_id=>wwv_flow_imp.id(5913195041676308)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5913868963676308)
,p_plugin_attribute_id=>wwv_flow_imp.id(5913195041676308)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5914275643676308)
,p_plugin_attribute_id=>wwv_flow_imp.id(5913195041676308)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5914677542676309)
,p_plugin_attribute_id=>wwv_flow_imp.id(5913195041676308)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5915082583676309)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(5910128867676305)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1933145006057747997)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5915391883676309)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5915601219676310)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5915983983676310)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5916240421676310)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5916586651676310)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5916852553676311)
,p_plugin_attribute_id=>wwv_flow_imp.id(5916586651676310)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5917266942676311)
,p_plugin_attribute_id=>wwv_flow_imp.id(5916586651676310)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5917682594676316)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5917995962676316)
,p_plugin_attribute_id=>wwv_flow_imp.id(5917682594676316)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5918375067676317)
,p_plugin_attribute_id=>wwv_flow_imp.id(5917682594676316)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5918776492676317)
,p_plugin_attribute_id=>wwv_flow_imp.id(5917682594676316)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5919167254676317)
,p_plugin_attribute_id=>wwv_flow_imp.id(5917682594676316)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5919576807676318)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5919869348676318)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5920284197676318)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5920614236676318)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5921020871676319)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5921401541676319)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5921821419676319)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5922272721676319)
,p_plugin_attribute_id=>wwv_flow_imp.id(5919576807676318)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5922634159676320)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5922970386676320)
,p_plugin_attribute_id=>wwv_flow_imp.id(5922634159676320)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5923377117676320)
,p_plugin_attribute_id=>wwv_flow_imp.id(5922634159676320)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5923792733676320)
,p_plugin_attribute_id=>wwv_flow_imp.id(5922634159676320)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5924164161676321)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5924401649676321)
,p_plugin_attribute_id=>wwv_flow_imp.id(5924164161676321)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5924824217676321)
,p_plugin_attribute_id=>wwv_flow_imp.id(5924164161676321)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5925205156676322)
,p_plugin_attribute_id=>wwv_flow_imp.id(5924164161676321)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5925604801676322)
,p_plugin_attribute_id=>wwv_flow_imp.id(5924164161676321)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5926083040676322)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5926379687676323)
,p_plugin_attribute_id=>wwv_flow_imp.id(5926083040676322)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5926762607676323)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5927069760676323)
,p_plugin_attribute_id=>wwv_flow_imp.id(5926762607676323)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5927407522676323)
,p_plugin_attribute_id=>wwv_flow_imp.id(5926762607676323)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5927823249676324)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1676252942327474484)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5928181043676325)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(5928486119676325)
,p_plugin_attribute_id=>wwv_flow_imp.id(5928181043676325)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5928846764676326)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5929122056676326)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1814359451285569612)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1814360710805573760)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1517407936389811182)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1800765822611162879)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1801445123341245983)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1814357516218524626)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1814358849608538483)
,p_plugin_id=>wwv_flow_imp.id(5907717028676296)
