...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5774593135676215)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5774862061676215)
,p_plug_template_id=>wwv_flow_imp.id(5774593135676215)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5775198402676215)
,p_plug_template_id=>wwv_flow_imp.id(5774593135676215)
,p_name=>'Sub Regions'
