...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5771023674676214)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5771361336676214)
,p_plug_template_id=>wwv_flow_imp.id(5771023674676214)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5771609750676214)
,p_plug_template_id=>wwv_flow_imp.id(5771023674676214)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5771918452676214)
,p_plug_template_id=>wwv_flow_imp.id(5771023674676214)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5772249950676215)
,p_plug_template_id=>wwv_flow_imp.id(5771023674676214)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5772529826676215)
,p_plug_template_id=>wwv_flow_imp.id(5771023674676214)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
