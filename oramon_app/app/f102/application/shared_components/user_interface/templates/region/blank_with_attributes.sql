...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5737726773676207)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5738043365676207)
,p_plug_template_id=>wwv_flow_imp.id(5737726773676207)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5738320072676208)
,p_plug_template_id=>wwv_flow_imp.id(5737726773676207)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5738662893676208)
,p_plug_template_id=>wwv_flow_imp.id(5737726773676207)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5738974740676208)
,p_plug_template_id=>wwv_flow_imp.id(5737726773676207)
,p_name=>'Sub Regions'
