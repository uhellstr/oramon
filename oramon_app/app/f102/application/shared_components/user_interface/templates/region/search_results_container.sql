...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5801698796676219)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5801967160676219)
,p_plug_template_id=>wwv_flow_imp.id(5801698796676219)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5802219067676219)
,p_plug_template_id=>wwv_flow_imp.id(5801698796676219)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5802576860676219)
,p_plug_template_id=>wwv_flow_imp.id(5801698796676219)
,p_name=>'Sub Regions'
