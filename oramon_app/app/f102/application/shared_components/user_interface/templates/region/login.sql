...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5799120254676219)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5799439527676219)
,p_plug_template_id=>wwv_flow_imp.id(5799120254676219)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5799777223676219)
,p_plug_template_id=>wwv_flow_imp.id(5799120254676219)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5800002026676219)
,p_plug_template_id=>wwv_flow_imp.id(5799120254676219)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5800323500676219)
,p_plug_template_id=>wwv_flow_imp.id(5799120254676219)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5800650531676219)
,p_plug_template_id=>wwv_flow_imp.id(5799120254676219)
,p_name=>'Sub Regions'
