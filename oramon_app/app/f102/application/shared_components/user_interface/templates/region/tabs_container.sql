...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5814175435676221)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5814426020676221)
,p_plug_template_id=>wwv_flow_imp.id(5814175435676221)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5814730921676221)
,p_plug_template_id=>wwv_flow_imp.id(5814175435676221)
,p_name=>'Tabs'
