...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5821850109676222)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5822184407676222)
,p_plug_template_id=>wwv_flow_imp.id(5821850109676222)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5822478019676223)
,p_plug_template_id=>wwv_flow_imp.id(5821850109676222)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5822777919676223)
,p_plug_template_id=>wwv_flow_imp.id(5821850109676222)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5823060362676223)
,p_plug_template_id=>wwv_flow_imp.id(5821850109676222)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5823372098676223)
,p_plug_template_id=>wwv_flow_imp.id(5821850109676222)
