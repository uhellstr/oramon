...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5744821781676208)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5745171423676209)
,p_plug_template_id=>wwv_flow_imp.id(5744821781676208)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5745443337676209)
,p_plug_template_id=>wwv_flow_imp.id(5744821781676208)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5745789410676209)
,p_plug_template_id=>wwv_flow_imp.id(5744821781676208)
,p_name=>'Sub Regions'
