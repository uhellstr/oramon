...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5796691244676218)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5796937232676218)
,p_plug_template_id=>wwv_flow_imp.id(5796691244676218)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5797224865676218)
,p_plug_template_id=>wwv_flow_imp.id(5796691244676218)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5797560122676218)
,p_plug_template_id=>wwv_flow_imp.id(5796691244676218)
,p_name=>'Button Start'
