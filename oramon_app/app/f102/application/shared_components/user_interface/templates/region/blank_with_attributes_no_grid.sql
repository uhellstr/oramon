...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5739133051676208)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5739499343676208)
,p_plug_template_id=>wwv_flow_imp.id(5739133051676208)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5739798026676208)
,p_plug_template_id=>wwv_flow_imp.id(5739133051676208)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5740004433676208)
,p_plug_template_id=>wwv_flow_imp.id(5739133051676208)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5740365672676208)
,p_plug_template_id=>wwv_flow_imp.id(5739133051676208)
,p_name=>'Sub Regions'
