...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5766432265676213)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5766747798676213)
,p_plug_template_id=>wwv_flow_imp.id(5766432265676213)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5767017413676213)
,p_plug_template_id=>wwv_flow_imp.id(5766432265676213)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5767334314676213)
,p_plug_template_id=>wwv_flow_imp.id(5766432265676213)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5767698460676213)
,p_plug_template_id=>wwv_flow_imp.id(5766432265676213)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5767952742676214)
,p_plug_template_id=>wwv_flow_imp.id(5766432265676213)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5768242756676214)
,p_plug_template_id=>wwv_flow_imp.id(5766432265676213)
,p_name=>'Sub Regions'
