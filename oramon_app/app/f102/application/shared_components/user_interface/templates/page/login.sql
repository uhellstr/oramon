...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(5710213452676199)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5710548115676199)
,p_page_template_id=>wwv_flow_imp.id(5710213452676199)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5710871635676199)
,p_page_template_id=>wwv_flow_imp.id(5710213452676199)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5711128563676199)
,p_page_template_id=>wwv_flow_imp.id(5710213452676199)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5711449892676199)
,p_page_template_id=>wwv_flow_imp.id(5710213452676199)
,p_name=>'Body Footer'
