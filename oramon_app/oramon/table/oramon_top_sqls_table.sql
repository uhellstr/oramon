  CREATE TABLE "ORAMON"."ORAMON_TOP_SQLS" 
   (	"INSTANCE_NUMBER" NUMBER NOT NULL ENABLE,
	...
	"MODULE" VARCHAR2(64),
	"SQL_TEXT" VARCHAR2(256) NOT NULL ENABLE,
	"EVENT_NAME" VARCHAR2(17) NOT NULL ENABLE,
	"INSTANCE_NAME" VARCHAR2(4000) NOT NULL ENABLE,
	"HOST_NAME" VARCHAR2(64) NOT NULL ENABLE,
	CONSTRAINT "ORAMON_TOP_SQLS_PK" PRIMARY KEY ("INSTANCE_NUMBER","DBID","B_SNAP_ID","E_SNAP_ID","B_SNAP_TIME","E_SNAP_TIME","EVENT_NAME","INSTANCE_NAME","HOST_NAME","SQL_TEXT")
  USING INDEX
  PCTFREE 10 INITRANS 2 MAXTRANS 149 LOGGING
