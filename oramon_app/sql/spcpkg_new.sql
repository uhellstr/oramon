Rem
Rem $Header: rdbms/admin/spcpkg.sql /main/54 2011/07/09 19:41:57 shsong Exp $
Rem
Rem spcpkg.sql
Rem
...
--Rem			Modified hint /*+ ordered use_nl(s) use_nl(sp.p) */ 
            select  /*+ no_merge(new_plan) NO_PUSH_PRED(new_plan)  leading(new_plan s sp)  use_nl(s) use_nl(sp) */ 
